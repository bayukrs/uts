      ...
      <div class="col-lg-9">
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
            ...
            <h4>Rp. <?php $harga = $detail['harga'] - ($detail['harga'] * 0.05);
                      echo number_format($harga,0,",",".");?></h4>
        ...
        <div class="card card-outline-secondary my-4">
          ...
          <div class="card-body">
            ...
            <input type="hidden" name="harga" value="<?php $harga = $detail['harga'] - ($detail['harga'] * 0.05);
                                                        echo $harga; ?>" />

      ...
      <div class="col-lg-9">
        <form action="<?php echo base_url()?>member/ubah_cart" method="post" name="frmShopping" id="frmShopping" class="formhorizontal" enctype="multipart/form-data">
	...
	// Create form and send all values in "shopping/update_cart" function.
			...
			?>
				...
				<tr>
					...
					<td>
						<a href="<?php echo base_url()?>member/hapus/<?php echo $item['rowid'];?>" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i>
						</a>
					</td>
					<?php 
						endforeach; 
				...
				<tr>
					...
					<td colspan="4" align="right">
						...
						<a href="<?php echo base_url()?>member/check_out" class ='btn btn-sm btn-primary'>Check Out</a>
					</td>
				</tr>
			</table>
 	...
 	<div class="modal fade" id="myModal" role="dialog">
 		...
 		<!-- Modal content-->
 			<div class="modal-content">
 				<form method="post" action="<?php echo base_url()?>member/hapus/all">

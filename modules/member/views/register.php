  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form method="post">
        ...
        <div class="input-group mb-3">
          <input type="telp" class="form-control" placeholder="Telp" name="telp" value="<?php echo set_value('telp'); ?>">
        ...
        <div class="input-group mb-3">
          <input type="alamat" class="form-control" placeholder="Alamat" name="alamat" value="<?php echo set_value('alamat'); ?>">
